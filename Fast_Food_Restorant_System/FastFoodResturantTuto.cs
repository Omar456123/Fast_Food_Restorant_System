...
namespace Fast_Food_Restorant_System
{
    public partial class FastFoodResturantTuto : Form
    {
        ...
        private void printBtn_Click(object sender, EventArgs e)
        {
            ...
            {
                ReceiptTb.AppendText("\t\tThank you for dining with us!" + Environment.NewLine);
                ReceiptTb.AppendText("\t\tWe hope to see you again soon!" + Environment.NewLine);
        ...
        {
            string receiptContent = ReceiptTb.Text;

            Font printFont = new Font("Arial", 12);
            float leftMargin = e.MarginBounds.Left;
            float topMargin = e.MarginBounds.Top;

            e.Graphics.DrawString(receiptContent, printFont, Brushes.Black, leftMargin, topMargin);
        }
